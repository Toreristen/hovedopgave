    ...
    <div>
        ...
        <article class="wrapper">
            ...
            <section class="item-a">
                <h2 class="heading">Er du en del af boligområdet</h2>
            ...
            <section class="item-b">
                <img src="../assets/img/ejendomme.jpg" alt="" class=" intro-img img-fluid">
            </section>
    
            <section class="item-c">
                <img src="../assets/img/odense-centrum.jpg" alt="" class="intro-img img-fluid">
            </section>
    
            <section class="item-d">
                <h2 class="heading">Specielt til ejendomsmæglere</h2>
        ...
        <section class="cta">
            <h2 class="cta-header">Hør mere om hvad vi kan gøre for din kommune</h2>
            <p class="cta-txt">Vi i Geodata er leverandør indenfor datadistribution og analyse til en bred vifte af forskellige erhverv. <br> Klik her for at finde ud af hvad vi kan gøre for dit erhverv</p>
            <a href="#" class="cta-btn">Læs mere</a>
...
@import "../components/frontpage/Intro.scss";
@import "../components/about/AboutCTA.scss";
</style>